...
AI/Data: LLMs, RAG Pipelines, TinyML, SQL, Data Visualization (Geopandas, Matplotlib).

Backend & DB: Node.js, Prisma, PostgreSQL.

Frontend & Mobile: Flutter, Web HTML/CSS.

🚀 Featured Projects:

🌱 Agri-GenAI: A research project applying GenAI and UAVs for agricultural image diagnosis.

🤟 GestureBridge: A recognition and communication support system for the hearing-impaired, utilizing multi-modal AI and Federated Learning.
